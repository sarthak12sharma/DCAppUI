...
public class DIALService extends DeviceService implements Launcher {
    ...
    public void launchAppWithInfo(final AndroidAppInfo androidAppInfo, Object params, final AppLaunchListener listener) {
        ServiceCommand<ResponseListener<Object>> command =
                new ServiceCommand<ResponseListener<Object>>(getCommandProcessor(),
                        requestURL(androidAppInfo.getName()), params, new ResponseListener<Object>() {
            @Override
            ...
            public void onSuccess(Object object) {
                ...
                launchSession.setAppName(androidAppInfo.getName());
    ...
    public void launchYouTube(String contentId, float startTime, AppLaunchListener listener) {
        String params = null;
        AndroidAppInfo androidAppInfo = new AndroidAppInfo("YouTube");
