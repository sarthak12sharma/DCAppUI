...
import com.example.cast.service.config.NetcastTVServiceConfig;
import com.example.cast.service.config.ServiceConfig;
import com.example.cast.service.config.ServiceDescription;
import com.example.cast.service.netcast.NetcastAppNumberParser;
import com.example.cast.service.netcast.NetcastApplicationsParser;
import com.example.cast.service.netcast.NetcastChannelParser;
import com.example.cast.service.netcast.NetcastHttpServer;
import com.example.cast.service.netcast.NetcastVirtualKeycodes;
import com.example.cast.service.netcast.NetcastVolumeParser;
...
public class NetcastTVService extends DeviceService implements Launcher, MediaControl, MediaPlayer, TVControl, VolumeControl, ExternalInputControl, MouseControl, TextInputControl, PowerControl, KeyControl {
    ...
    List<AndroidAppInfo> applications;
    ...
    public NetcastTVService(ServiceDescription serviceDescription, ServiceConfig serviceConfig) {
        ...
        applications = new ArrayList<AndroidAppInfo>();
...
//        mServiceReachability.start();
    ...
    public void getApplication(final String appName, final AppInfoListener listener) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            public void onSuccess(Object response) {
                ...
                AndroidAppInfo appId = new AndroidAppInfo() {{
    ...
    private void getAppInfoForId(final String appId, final AppInfoListener listener) {
        getAppList(new AppListListener() {
            ...
            @Override
            public void onSuccess(List<AndroidAppInfo> object) {
                for (AndroidAppInfo info : object) {
    ...
    private void launchApplication(final String appName, final String auid, final String contentId, final AppLaunchListener listener) {
    ...
    @Override
    public void launchAppWithInfo(AndroidAppInfo androidAppInfo, Object params, AppLaunchListener listener) {
        String appName = HttpMessage.encode(androidAppInfo.getName());
        String appId = androidAppInfo.getId();
    ...
    public void launchBrowser(String url, final AppLaunchListener listener) {
        ...
        getApplication(appName, new AppInfoListener() {
            ...
            public void onSuccess(AndroidAppInfo androidAppInfo) {
                String contentId = null;
                launchApplication(appName, androidAppInfo.getId(), contentId, listener);
            }
    ...
    public void launchYouTube(final String contentId, float startTime, final AppLaunchListener listener) {
        ...
        if (startTime <= 0.0) {
            getApplication("YouTube", new AppInfoListener() {
                ...
                @Override
                public void onSuccess(AndroidAppInfo androidAppInfo) {
                    launchApplication(androidAppInfo.getName(), androidAppInfo.getId(), contentId, listener);
                }
    ...
    public void launchNetflix(final String contentId, final AppLaunchListener listener) {
        ...
        getApplication(appName, new AppInfoListener() {
            ...
            @Override
            public void onSuccess(final AndroidAppInfo androidAppInfo) {
                JSONObject jsonObj = new JSONObject();

                try {
                    jsonObj.put("id", androidAppInfo.getId());
                ...
                ResponseListener<Object> responseListener = new ResponseListener<Object>() {
                    ...
                    @Override
                    public void onSuccess(Object response) {
                        LaunchSession launchSession = LaunchSession.launchSessionForAppId(androidAppInfo.getId());
                        launchSession.setAppName(appName);
                        launchSession.setService(NetcastTVService.this);
                        launchSession.setSessionType(LaunchSessionType.App);
        ...
        getTotalNumberOfApplications(2, new AppCountListener() {
            ...
            public void onSuccess(final Integer count) {
                getApplications(2, count, new AppListListener() {
                    ...
                    @Override
                    public void onSuccess(List<AndroidAppInfo> apps) {
    ...
    public void launchInputPicker(final AppLaunchListener listener) {
        ...
        getApplication(encodedStr, new AppInfoListener() {
            ...
            @Override
            public void onSuccess(final AndroidAppInfo androidAppInfo) {
                AppLaunchListener launchListener = new AppLaunchListener() {
                ...
                launchApplication(appName, androidAppInfo.getId(), null, launchListener);
            }
    ...
    public void displayImage(final String url, final String mimeType, final String title, final String description, final String iconSrc, final LaunchListener listener) {
        if (getDLNAService() != null) {
            final LaunchListener launchListener = new LaunchListener() {
