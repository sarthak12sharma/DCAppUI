 ...
 */
package com.example.cast.service.webos;
...
import com.example.cast.core.ProgramInfo;
import com.example.cast.core.ProgramList;
    ...
    protected ServiceCommand<Launcher.AppInfoListener> getRunningApp(boolean isSubscription, final Launcher.AppInfoListener listener) {
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            public void onSuccess(Object response) {
                ...
                AndroidAppInfo app = new AndroidAppInfo() {{
