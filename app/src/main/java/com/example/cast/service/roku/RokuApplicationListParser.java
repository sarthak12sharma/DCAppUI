...
package com.example.cast.service.roku;
...
public class RokuApplicationListParser extends DefaultHandler {
    ...
    public List<AndroidAppInfo> appList;
    public AndroidAppInfo androidAppInfo;

    public RokuApplicationListParser() {
        value = null;
        appList = new ArrayList<AndroidAppInfo>();
    }
    ...
    public List<AndroidAppInfo> getApplicationList() {
        return appList;
    }
}
