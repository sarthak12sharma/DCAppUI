...
package com.example.cast.service.capability;
...
public interface Launcher extends CapabilityMethods {
     ...
     */
    public static interface AppInfoListener extends ResponseListener<AndroidAppInfo> { }
     ...
     */
    public static interface AppListListener extends ResponseListener<List<AndroidAppInfo>> { }
