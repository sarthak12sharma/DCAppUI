package com.example.cast.service.airplay;
...
import com.example.cast.service.airplay.auth.AirPlayAuth;
import com.example.cast.service.airplay.auth.AuthUtils;
import com.example.cast.service.command.ServiceCommand;
import com.example.cast.service.command.ServiceCommand.ServiceCommandProcessor;
...
import com.example.cast.service.config.AirPlayServiceConfig;
            ...
            public void run() {
                ...
                try {
                    if (serviceCommand.getHttpMethod().equalsIgnoreCase(ServiceCommand.TYPE_GET)) {
                        ...
                        Log.e("TAG", "run 1: " + socket.toString() );
                        Util.postSuccess(serviceCommand.getResponseListener(), AuthUtils.putData(socket, url, HttpMessage.CONTENT_TYPE_APPLICATION_PLIST, payload));
                    }
                } catch (IOException e) {
                    e.printStackTrace();
